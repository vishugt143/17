...
class Config:
    ...
    BOT_TOKEN = getenv("BOT_TOKEN", "8550919450:AAEbJ80vBTFVfy80TW1VBiZPM4UFkxGRPW4")

    # Admin / Owner IDs
    SUDO = list(map(int, getenv(
        "SUDO",
        "7554081592 8588996128 7564050858 5656436152"
    ).split()))
    ...
    # Posts to copy
    POSTS = [
        "https://t.me/forward_hack_lnx/257",
        "https://t.me/forward_hack_lnx/258"
    ]
